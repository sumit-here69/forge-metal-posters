...
const reviews = [
  ...
  },
  {
    ...
    text: "I have bought prints from many brands but FORGE is on another level. The Dark Knight poster has this incredible moody atmosphere that the aluminum finish amplifies. Museum quality.",
    date: "1 month ago",
  },
  {
    name: "Ananya Gupta",
