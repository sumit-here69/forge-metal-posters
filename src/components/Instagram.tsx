      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-10">
        <div className="text-center">
          ...
          <p className="text-neutral-500 mt-3">
            Tag us to get featured. Real setups from real customers.
          </p>
        </div>
      </div>
      ...
      <div className="flex gap-3 px-3">
        {socialImages.map((src, i) => (
          <motion.div
            ...
            className="flex-1 min-w-[160px] aspect-square rounded-xl overflow-hidden group cursor-pointer relative"
          >
            <Image
              src={src}
              alt={`Customer room setup ${i + 1}`}
              fill
